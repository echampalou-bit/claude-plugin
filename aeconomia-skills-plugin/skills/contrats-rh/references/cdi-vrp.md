...
| Art. 5 | Organisation du travail | Activité itinérante |
| Art. 6 | Télétravail | Renvoi à la Charte Télétravail |
| Art. 7 | Mobilité géographique | Accord préalable pour hors-secteur |
| Art. 8 | Secret professionnel | Standard |
...
| Art. 16 | Indemnité de clientèle | L.7313-12+ |
| Art. 17 | Retour sur échantillonnage | Commissions post-rupture : 3 mois max |
| Art. 18 | Exclusivité | Interdiction activité concurrente pendant contrat |
| Art. 19 | Non-sollicitation | 1 an post-contrat, salariés + apporteurs + partenaires |
| Art. 20 | Non-concurrence | 12 mois, 30%, Centre-Val-de-Loire + limitrophes |
| Art. 21 | Restitution matériel | Standard |
| Art. 22 | Obligations particulières | Image, réseaux sociaux |
| Art. 23 | Données personnelles | RGPD, ORCOM sous-traitant paie |
| Art. 24 | Rupture | Préavis CCN VRP (1/2/3 mois) |
| Art. 25 | LCB-FT et réclamations | KYC, signalement, délais réclamation |
...
Missions : négociation prêts immobiliers, renégociation, rachat de crédits, assurances emprunteurs, et toutes activités en lien.
Obligations détaillées : développement réseau apporteurs, portefeuille client, suivi commercial, relations bancaires, montage dossiers.
La Société peut modifier les produits commercialisés unilatéralement.

### Article 3 — Secteur
- Rattachement à une agence nommée [XXX]
- Secteur géographique prioritaire [XXX/XXX]
- Possibilité d'intervenir hors secteur pour opportunités
- Prospection active hors secteur = validation préalable requise
...
- Rétrocessions sur frais de distribution uniquement si production directe du courtier
- Minimum 300€ de frais de distribution par emprunteur
- Rattachement client limité à 2 mois
- Indépendant du CA courtage (pas de cumul dans les paliers)

⚠️ **Point critique identifié** : le barème détaillé des taux de commission par palier de CA est souvent manquant ou incomplet dans le document. Toujours vérifier sa présence et sa cohérence.

### Article 15 — Équipements et véhicule
- PC portable + carte bancaire plafonnée (propriété société)
- Véhicule de service : « ne peut être utilisé qu'à des fins professionnelles, y compris trajets domicile-travail »
- Renvoi à la politique interne véhicules (Notion)
- L'architecture à deux niveaux (contrat strict / note souple) est intentionnelle

### Article 19 — Non-sollicitation
- Durée : pendant le contrat + 1 an après
- Périmètre : salariés, filiales, apporteurs, partenaires bancaires, notaires, agents immobiliers
- Pas de contrepartie financière (normal pour une clause de non-sollicitation)
- Attention : si le périmètre est trop large → risque de requalification en non-concurrence déguisée

### Article 20 — Non-concurrence
- Durée : 12 mois post-cessation
- Périmètre : courtage crédit immobilier + produits/services art. 2
- Géographie : Centre-Val-de-Loire + départements limitrophes
- Contrepartie : 30% de la moyenne mensuelle brute (fixe + variable) des 12 derniers mois
- Versement mensuel pendant la durée de la clause
- Renonciation possible sous 15 jours après notification de rupture
